...
const ProfileMenu = ({ collapsed = false }) => {
  ...
  return (
    <div ref={menuRef} className="relative">
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="w-full flex items-center gap-3 p-2.5 rounded-[10px] hover:bg-primary-100 transition-colors group"
      >
        ...
        <div className="flex-1 min-w-0 text-left">
          <p className="font-medium text-sm text-text truncate">{displayData.name}</p>
