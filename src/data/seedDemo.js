...
// These profiles match the sampleUsers.js for consistency
...
export const generateNotifications = (role) => {
    ...
    housekeeping: [
      {
        ...
        read: false,
        priority: 'urgent',
        actionUrl: '/housekeeping/rooms/418'
      },
      {
        id: 'notif-hk-002',
        type: 'task',
      ...
      },
      {
        ...
        read: false,
        priority: 'high',
        actionUrl: '/housekeeping/rooms/205'
      }
    ],
    maintenance: [
      {
        ...
        read: false,
        priority: 'urgent',
        actionUrl: '/maintenance/work-orders/wo-003'
      },
      {
        id: 'notif-mt-002',
        type: 'task',
        ...
        read: false,
        priority: 'high',
        actionUrl: '/maintenance/work-orders/wo-001'
      },
      {
        id: 'notif-mt-003',
        type: 'info',
    ...
    runner: [
      {
        ...
        read: false,
        priority: 'urgent',
        actionUrl: '/runner/pickup-requests'
      },
      {
        id: 'notif-rn-002',
        type: 'task',
...
export const seedDemoData = (role = 'housekeeping') => {
  return {
