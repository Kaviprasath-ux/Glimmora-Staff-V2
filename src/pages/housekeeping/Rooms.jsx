              ...
              >
                ...
                <div className="space-y-2 mb-4">
                  ...
                  {room.guestName && (
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium text-text truncate max-w-[150px]">{room.guestName}</span>
                    </div>
                  )}
                </div>
                ...
                {room.specialRequests && (
                  <div className="p-2.5 rounded-lg bg-gold/10 mb-4">
                    ...
                    <p className="text-xs text-text-light mt-0.5 line-clamp-2">{room.specialRequests}</p>
                  </div>
                )}
